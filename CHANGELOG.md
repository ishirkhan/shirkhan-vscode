...
* 转换器传错参数问题修复,ug转khan 修改成ug转khan-uz[是因为uz 和khan支持混写,这时直接在uz的基础上继续编写更佳] ([9ad837b](https://github.com/ishirkhan/shirkhan-vscode/commit/9ad837b54558469a22ebf37f3c2e25856510f168))
