...
// node_modules/shirkhan-alphabet/dist/shirkhan-alphabet.es.js
var SEPARATE_MARK = "h";
var HEMZE = "\u0626";
var table$1 = [
  {
...
var Uly = class extends Base {
  constructor() {
    super(...arguments);
    __publicField$1(this, "type", "uly");
  }
};
var khan = new Khan(table$1, HEMZE);
function khanText2ug(text) {
  return khan.toUgText(text);
}
var uly = new Uly(table$1, HEMZE);
var BOUND_FLAG = String.fromCharCode(0);

// src/markdownItPlugin.js
